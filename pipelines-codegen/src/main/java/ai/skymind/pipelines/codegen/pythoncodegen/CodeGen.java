...
package ai.skymind.pipelines.codegen.pythoncodegen;

import ai.skymind.pipelines.InferenceConfiguration;
import ai.skymind.pipelines.model.*;
import ai.skymind.pipelines.pipeline.*;
import ai.skymind.pipelines.serving.*;
import ai.skymind.pipelines.model.SavedModelConfig;
...
/**
 * Pipelines Python client generator
 *
 */
public class CodeGen {
    public static void main( String[] args ) throws Exception {
        ...
        pythonImports.append("from pipes.json_utils import dict_with_type,DictWrapper,ListWrapper\n");

        File newModule = new File( projectBasePath + sep + "client" + sep + "pipes" + sep + "inference.py");
        newModule.delete();
        ...
        for(Class<?> clazz : clazzes) {
            ...
            File pythonFile = new File(String.format(projectBasePath + sep + "client" + sep +"%s.py",clazz.getSimpleName().toLowerCase()));
        ...
        sb.append("from pipes.json_utils import dict_with_type,DictWrapper,ListWrapper\n");
