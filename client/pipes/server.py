from pipes.inference import InferenceConfiguration
...
class Server(object):
    ...
    def start(self):
        ...
        args.append('ai.skymind.pipelines.configprovider.PipelineServerMain')
        args.append('--configPath')
        args.append(abs_path)
        args.append('--verticleClassName')
        args.append('ai.skymind.pipelines.verticles.inference.InferenceVerticle')
