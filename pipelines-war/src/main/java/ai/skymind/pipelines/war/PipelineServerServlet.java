package ai.skymind.pipelines.war;
 ...
 */
@Slf4j
public class PipelineServerServlet extends HttpServlet {

    private Vertx vertx;
    private HttpClient httpClient;
    private JsonObject vertxConfig;

    public final static String CLASS_NAME = "ai.skymind.pipelines.class";
    public final static String CONFIG_JSON = "ai.skymind.pipelines.configpath";
    public final static int DEFAULT_HTTP_PORT = 8081;

    public PipelineServerServlet() {
        super();
    }
