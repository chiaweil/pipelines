 ...
 * @author Adam Gibson
 */
public class PipelineServerMain {
    ...
    private static Logger log = LoggerFactory.getLogger(PipelineServerMain.class.getName());
    ...
    public static void main(String...args) {
        try {
            ...
            new PipelineServerMain().runMain(args);
