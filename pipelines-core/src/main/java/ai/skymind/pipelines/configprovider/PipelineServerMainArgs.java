...
import ai.skymind.pipelines.configprovider.args.InputDataType;
import ai.skymind.pipelines.configprovider.args.ModelType;
 ...
 * please see {@link PipelineServerMain}
 *
 * @author Adam Gibson
 */
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class PipelineServerMainArgs implements Serializable {
    ...
    public String[] toArgs() {
        if(fields == null) {
            fields = PipelineServerMainArgs.class.getDeclaredFields();
