...
package ai.skymind.pipelines.model.loader.dl4j.mln;
...
@AllArgsConstructor
@Data
public class MultiLayerNetworkModelLoader implements ModelLoader<MultiLayerNetwork> {
    ...
    public MultiLayerNetwork loadModel() throws Exception {
        return (MultiLayerNetwork) ai.skymind.pipelines.model.loader.ModelGuesser.loadModelGuess(pathToModel.getAbsolutePath());
    }
}
