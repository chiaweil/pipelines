...
package ai.skymind.pipelines.train;
...
38,Private,College,Unmarried,Service,81838,Female,FALSE,72,0
    ...
    public static TestConfig getPretrainedMnist() throws Exception {
        ...
        org.nd4j.linalg.dataset.api.preprocessor.DataNormalization scaler = new ai.skymind.pipelines.normalizer.CustomImagePreProcessingScaler(0, 1);
