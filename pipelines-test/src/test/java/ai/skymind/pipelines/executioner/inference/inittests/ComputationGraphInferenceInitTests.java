...
import ai.skymind.pipelines.executioner.inference.ComputationGraphInferenceExecutioner;
...
public class ComputationGraphInferenceInitTests {
    ...
    public void testComputationGraph() throws Exception {
        ComputationGraphInferenceExecutioner multiLayerNetworkInferenceExecutioner = new ComputationGraphInferenceExecutioner();
