...
package ai.skymind.pipelines.output.adapter.multi.impl;
...
import ai.skymind.pipelines.output.adapter.SSDOutputAdapter;
import ai.skymind.pipelines.output.adapter.YOLOOutputAdapter;
