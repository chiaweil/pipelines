...
if __name__ == '__main__':
    ...
    parser.add_argument('--target', type=str,
                        help='the path to the model server output',default='pipelines.jar')
    ...
    copyfile(
        os.path.join(args.source, 'pipelines-uberjar', 'target', 'pipelines-uberjar-{}-bin.jar'.format(PROJECT_VERSION)),
        args.target
    )
